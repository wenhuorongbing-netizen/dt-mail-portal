...
Create these issues after pushing the repo.

## Milestone: MVP-1 Portal Prototype
...
## Milestone: MVP-2 Admin Workflow

- #6 Create admin shell and sidebar
- #7 Create order list module
- #8 Create new order form
- #9 Implement 10th-day price calculator
...
- #21 Add authentication hardening
