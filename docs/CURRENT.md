...
Project: **SpirePlus** (`zmqjcwxrkvbtmtcfucwo`) on AWS eu-north-1.
URL: `https://zmqjcwxrkvbtmtcfucwo.supabase.co`
...
13. ✅ Apply schema + policies to real Supabase (SpirePlus project, SQL Editor)
14. ✅ Verify RLS/RPC on real Supabase with anon key (6/6 tests passed)
15. ✅ GitHub Pages deployment with real env vars (https://wenhuorongbing-netizen.github.io/dt-mail-portal/)
16. ✅ Create wallet_only + managed_otp test orders and verify customer pages
